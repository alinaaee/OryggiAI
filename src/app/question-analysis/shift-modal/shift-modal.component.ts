...
@Component({
  ...
  imports: [CommonModule, MatFormFieldModule, FormsModule, MatInputModule, MatIconModule, MatDialogModule, MatButtonModule, MatTableModule],
  templateUrl: './shift-modal.component.html',
  styleUrl: './shift-modal.component.css'
})

export class ShiftModalComponent {
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, private dialogRef: MatDialogRef<ShiftModalComponent>) {
  ...
  save() {
    ...
    console.log('Shifts saved:', this.shifts);
  }
}
